    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        linear_menu_tutorial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(System.currentTimeMillis()>btnPressTime+1000){
                    ...
                    String text2 = "도움말";
                    Toast.makeText(CameraInfoActivity.this, text2, Toast.LENGTH_SHORT).show();
                ...
                if(System.currentTimeMillis()<=btnPressTime+1000){
                    Intent it = new Intent(CameraInfoActivity.this,HelpActivity.class);
        ...
        linear_menu_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(System.currentTimeMillis()<=btnPressTime+1000){
                    Intent it = new Intent(CameraInfoActivity.this,MapActivity.class);
        ...
        linear_menu_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(System.currentTimeMillis()<=btnPressTime+1000){
                    Intent it = new Intent(CameraInfoActivity.this,DetectorActivity.class);
